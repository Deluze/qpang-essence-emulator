...
void QpangConnection::read()
{
	...
	{
		std::cout << "QpangConnection::read " << e.message() << std::endl;
	}
}
...
void QpangConnection::close()
{
	...
	{
		std::cout << "QpangConnection::close " << e.what() << "\n";
	}
	...
	{
		std::cout << "QpangConnection::close " << e.message() << "\n";
	}
}
...
void QpangConnection::onHeaderRead(const boost::system::error_code& e)
{
	try
	{
		...
		{
			std::cout << "QpangConnection::onPacketReceive " << e.message() << std::endl;
		}
	}
	catch (const std::exception& ee)
	{
		std::cout << "QPangCOnnection::onPacketReceive " << ee.what() << std::endl;
	}
}
...
void QpangConnection::write(std::vector<char> buff)
{
	...
	{
		std::cout << "QpangConnection::write " << ec.message() << std::endl;
		close();
	}
}
...
void QpangConnection::onWriteFinish(const boost::system::error_code& e)
{
	if (e)
	{
		std::cout << "QpangConnection::onWriteFinish " << e.message() << std::endl;
		close();
	}
}
