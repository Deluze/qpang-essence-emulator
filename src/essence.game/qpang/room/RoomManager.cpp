...
std::shared_ptr<Room> RoomManager::create(const std::u16string& name, uint8_t map, uint8_t mode)
{
...
void RoomManager::remove(const uint32_t id)
{
	std::lock_guard lg(m_roomMx);
...
GameModeManager* RoomManager::getGameModeManager() const
{
